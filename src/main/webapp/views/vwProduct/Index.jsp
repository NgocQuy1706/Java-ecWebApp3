...
<jsp:useBean id="products" scope="request" type="java.util.List<com.ute.ecwebapp3.beans.Product>"/>
                        ...
                        <table class="table table-hover">
                            ...
                            <c:forEach items="${products}" var="c">
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <a class="btn btn-outline-primary " href="${pageContext.request.contextPath}/Admin/Product/Edit?id${c.proID}" role="button">

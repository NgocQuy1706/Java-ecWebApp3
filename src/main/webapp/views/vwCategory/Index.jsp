...
<jsp:useBean id="categories" scope="request" type="java.util.List<com.ute.ecwebapp3.beans.Category>"/>

<t:main>
    <jsp:body>
        <div class="card">
            <h4 class="card-header d-flex justify-content-between" >
                <a  class="btn btn-primary  " href="${pageContext.request.contextPath}/Admin/Category/Add" role="button">+</a>
                Categories
